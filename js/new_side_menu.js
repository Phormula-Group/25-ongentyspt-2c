...
const menu_names = ["ONGENTYS","Adoption Clinical Program","OASYS Study"];
const IEC_html = "35_slide.html";
const IEC_pdf = "iec.pdf";
...
<ul class="side_menu">
                <li class="menu_li homebtn" style="">
                    ...
                    <img style="width: 45px;" src="assets/side-menu/home.png" alt="">
                    </a>
                </li>
                <li class="menu_li menu_li_flow menulistbtn" style="">
                    <img class="flowImgBtn" style="width: 45px;" src="assets/side-menu/sitemap.png" alt="">
                    <div id="flows_list" class="hide_this">
                        <ul class="menuflows">
                            <li id="flow_01" class="flow" style="">
                                <span>${menu_names[0]}</span>
                                <img src="assets/side-menu/sitemap.png" alt="">
                            </li>
            ...
            <!-- <li class="menu_li iecSlide" style="opacity: 1;">
                ...
                <li class="menu_li goback" style="display: block;">
                    <img src="assets/side-menu/back.png" alt="">
                </li>
            </ul>
`;
...
liElement.addEventListener('click', function(event) {
    ...
    const image1Src = "assets/side-menu/sitemap.png";
    const image2Src = "assets/side-menu/sitemap-ativo.png";
