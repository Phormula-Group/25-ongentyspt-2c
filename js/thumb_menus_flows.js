...
///////////////// CONTENT TO BE INSERTED OVER THE FLOWS THUMBS /////////////////
...
<img style="width: 100%;" src="assets/side-menu/flow_04.png" alt="">
<span class="closeFlow" style="width:30px; height: 30px; position: absolute; top: 207px; right: 121px;"></span>
<a id="thumb15" href="javascript:CLMPlayer.gotoSlide(null, '15_slide.html',null);" style="position: absolute; top: 35%; left: 11.4%; z-index: 99;"></a>
<a id="thumb16" href="javascript:CLMPlayer.gotoSlide(null, '16_slide.html',null);" style="position: absolute; top: 35%; left: 24.7%; z-index: 99;"></a>
<a id="thumb17" href="javascript:CLMPlayer.gotoSlide(null, '17_slide.html',null);" style="position: absolute; top: 35%; left: 38%; z-index: 99;"></a>
<a id="thumb18" href="javascript:CLMPlayer.gotoSlide(null, '18_slide.html',null);" style="position: absolute; top: 35%; left: 51%; z-index: 99;"></a>
<a id="thumb19" href="javascript:CLMPlayer.gotoSlide(null, '19_slide.html',null);" style="position: absolute; top: 35%; left: 64%; z-index: 99;"></a>
<a id="thumb20" href="javascript:CLMPlayer.gotoSlide(null, '20_slide.html',null);" style="position: absolute; top: 35%; left: 77%; z-index: 99;"></a>
<a id="thumb21" href="javascript:CLMPlayer.gotoSlide(null, '21_slide.html',null);" style="position: absolute; top: 60%; left: 12%; z-index: 99;"></a>
<a id="thumb22" href="javascript:CLMPlayer.gotoSlide(null, '22_slide.html',null);" style="position: absolute; top: 60%; left: 25%; z-index: 99;"></a>
<a id="thumb23" href="javascript:CLMPlayer.gotoSlide(null, '23_slide.html',null);" style="position: absolute; top: 60%; left: 38%; z-index: 99;"></a>
<a id="thumb24" href="javascript:CLMPlayer.gotoSlide(null, '24_slide.html',null);" style="position: absolute; top: 60%; left: 51%; z-index: 99;"></a>
<a id="thumb25" href="javascript:CLMPlayer.gotoSlide(null, '25_slide.html',null);" style="position: absolute; top: 60%; left: 64%; z-index: 99;"></a>
<a id="thumb26" href="javascript:CLMPlayer.gotoSlide(null, '26_slide.html',null);" style="position: absolute; top: 60%; left: 77%; z-index: 99;"></a>
`;*/

/*const flow05_content = `
<img style="width: 100%;" src="assets/side-menu/flow_05.png" alt="">
<span class="closeFlow" style="width:30px; height: 30px; position: absolute; top: 207px; right: 121px;"></span>
<a id="thumb15" href="javascript:CLMPlayer.gotoSlide(null, '15_slide.html',null);" style="position: absolute; top: 35%; left: 11.4%; z-index: 99;"></a>
<a id="thumb16" href="javascript:CLMPlayer.gotoSlide(null, '16_slide.html',null);" style="position: absolute; top: 35%; left: 24.7%; z-index: 99;"></a>
<a id="thumb17" href="javascript:CLMPlayer.gotoSlide(null, '17_slide.html',null);" style="position: absolute; top: 35%; left: 38%; z-index: 99;"></a>
...
///////////////// INSERT LINKS OVER FLOW THUMBS /////////////////

if (flow01_content) {
	const div01 = document.getElementById('menu_01');
	div01.insertAdjacentHTML('afterbegin', flow01_content);
}

if (flow02_content) {
	const div02 = document.getElementById('menu_02');
	div02.insertAdjacentHTML('afterbegin', flow02_content);
}


if (flow03_content) {
	const div03 = document.getElementById('menu_03');
	div03.insertAdjacentHTML('afterbegin', flow03_content);
}

if (flow04_content) {
	const div04 = document.getElementById('menu_04');
	div04.insertAdjacentHTML('afterbegin', flow04_content);
}

if (flow05_content) {
	const div05 = document.getElementById('menu_05');
	div05.insertAdjacentHTML('afterbegin', flow05_content);
}